...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const {user_id, channel_id} = parseQuery(router.asPath.split("?")[1]);
    console.log("parsed id, faliover", user_id, channel_id)
  ...
  async function initPlayerSrc(user_id, channel_id) {

    const url = `https://b1r4n6uph6.execute-api.eu-west-1.amazonaws.com/dev/channel/get/${user_id}/${channel_id}`
